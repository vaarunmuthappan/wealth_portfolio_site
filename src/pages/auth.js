...
export const Auth = () => {
    return (<div className="auth">
        ...
        <div className="flex-parent-element">
            <div className="flex-child-element"><Login /></div>
            <div className="flex-child-element"><Register /></div>
        </div>
    </div>);
}
    ...
    return (
        <div className="auth-container">
            <form onSubmit={onSubmit}>
                ...
                <button className="bn632-hover bn21" type="submit">{label}</button>
            </form>
        </div>);
}